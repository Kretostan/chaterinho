...
const Hero = () => {
	return (
		<header className="flex flex-col justify-center items-center gap-8 md:gap-10 lg:gap-12 mt-20 px-4 pt-20 pb-18 min-h-screen w-full bg-accent text-center">
			...
			<div className="bg-elevated mx-4 mt-6 p-5 md:px-12 md:py-10 rounded-2xl max-w-[900px] w-full">
				<div className="flex flex-col bg-main p-5 gap-4 rounded-xl">
					<div className="flex bg-elevated p-4 gap-4 border-1 border-border rounded-lg">
						<div className="flex items-center justify-center w-10 h-10 bg-accent font-semibold text-white rounded-full">
							JD
						</div>
					...
					<div className="flex justify-start">
						<p className="p-3 bg-elevated max-w-2/3 md:max-w-1/2 rounded-t-2xl rounded-br-2xl text-sm">
							Hey team! How&apos;s the project coming along?
						</p>
					</div>
					<div className="flex justify-end">
						<p className="p-3 bg-green-800 max-w-2/3 md:max-w-1/2 rounded-t-2xl rounded-bl-2xl text-sm">
