...
const Hero = () => {
  return <header className="flex flex-col justify-center items-center gap-8 lg:gap-12 mt-20 px-4 pt-20 pb-18 min-h-screen w-full bg-accent text-center">
    <div className="flex flex-col justify-center items-center gap-6 lg:gap-10 px-2 md:px-0">
      <h1 className="font-bold text-white text-2xl md:text-3xl lg:text-6xl">Connect. Collaborate. Communicate.</h1>
      <p className="max-w-[400px] lg:max-w-[550px] text-lg lg:text-xl">Experience seamless team communication with our modern, intuitive chat platform designed for the future of work.</p>
    </div>
    <div className="flex flex-col md:flex-row gap-6 px-4 md:px-0 w-full md:w-auto">
      <PrimaryButton>Start Free Trial</PrimaryButton>
      <OutlineButton>Watch Demo</OutlineButton>
    </div>
    <div className="bg-elevated mx-4 p-5 md:px-12 md:py-10 rounded-2xl max-w-[900px] w-full">
